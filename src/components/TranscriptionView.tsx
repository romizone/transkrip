...
export default function TranscriptionView({ transcription, onBack }: TranscriptionViewProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-8 py-8">
      ...
      <button
        onClick={onBack}
        className="w-full mt-6 py-3 rounded-xl font-medium text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 shadow-lg shadow-indigo-500/25 transition-all flex items-center justify-center gap-2"
      >
